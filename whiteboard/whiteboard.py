...
color_box=PhotoImage(file=r"D:\coding\python\mainproject\whiteboard\color section.png")
Label(root,image=color_box,bg="#f2f3f5").place(x=10,y=20)

eraser=PhotoImage(file=r"D:\coding\python\mainproject\whiteboard\eraser.png")
